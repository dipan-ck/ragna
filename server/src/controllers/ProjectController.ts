...
export async function chatWithModel(req: Request, res: Response) {
  try {
...
export async function getAllChats(req: Request, res: Response) {
  try {
    ...
    const query: any = { projectId, userId };
    if (before) {
...
export async function updateProject(req: Request, res: Response) {
  try {
    ...
    if (AgentInstructions) updateFields.AgentInstructions = AgentInstructions;
