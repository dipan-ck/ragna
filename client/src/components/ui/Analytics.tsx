...
export default function Analytics() {
  ...
  return (
    <div className="w-[90%] relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mx-auto mt-2">
      {analyticsData.map((card) => (
        <div key={card.title} className=  'bg-[#18181871] relative  border border-[#2A2A2A] rounded-2xl p-4 flex flex-col justify-between transition hover:shadow-md hover:border-[#3A3A3A]'>
